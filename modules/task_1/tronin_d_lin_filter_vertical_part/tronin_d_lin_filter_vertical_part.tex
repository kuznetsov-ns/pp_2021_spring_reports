...
\begin{figure}[H]
    \centering
    \subfloat[\centering Оригинальное изображение]{{\includegraphics[width=5cm]{./tronin_images/tower.jpg}}}
    \qquad
    \subfloat[\centering Обработанное изображение]{{\includegraphics[width=5cm]{./tronin_images/tower1.jpg}}}
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat[\centering Оригинальное изображение]{{\includegraphics[width=5cm]{./tronin_images/unn_logo.png}}}
    \qquad
    \subfloat[\centering Обработанное изображение]{{\includegraphics[width=5cm]{./tronin_images/unn_logo1.png}}}
\end{figure}
