...
\begin{figure}[H]
    \centering
    \subfloat[\centering Оригинальное изображение]{{\includegraphics[width=5cm]{tower.jpg}}}
    \qquad
    \subfloat[\centering Обработанное изображение]{{\includegraphics[width=5cm]{tower1.jpg}}}
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat[\centering Оригинальное изображение]{{\includegraphics[width=5cm]{unn_logo.png}}}
    \qquad
    \subfloat[\centering Обработанное изображение]{{\includegraphics[width=5cm]{unn_logo1.png}}}
\end{figure}
