...
\begin{figure}[H]
\center{\includegraphics[scale=0.8]{./img/abc-mask1.png}}
...
\begin{figure}[H]
\center{\includegraphics[scale=0.8]{./img/abc-mask2.png}}
...
\begin{figure}[H]
\center{\includegraphics[scale=1.2]{./img/128.png}}
\caption{Бинарное изображение 128x128}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1.2]{./img/seq128.png}}
\caption{Последовательная реализация 128x128}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1.2]{./img/omp128.png}}
\caption{OMP реализация 128x128}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1.2]{./img/tbb128.png}}
\caption{TBB реализация 128x128}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1]{./img/256.png}}
\caption{Бинарное изображение 256x256}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1]{./img/seq256.png}}
\caption{Последовательная реализация 256x256}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1]{./img/omp256.png}}
\caption{OMP реализация 256x256}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=1]{./img/tbb256.png}}
\caption{TBB реализация 256x256}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.4]{./img/800x500.png}}
\caption{Бинарное изображение 800x500}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.4]{./img/seq800x500.png}}
\caption{Последовательная реализация 800x500}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.4]{./img/omp800x500.png}}
\caption{OMP реализация 800x500}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.4]{./img/tbb800x500.png}}
\caption{TBB реализация 800x500}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.2]{./img/1450x1000.png}}
\caption{Бинарное изображение 1450x1000}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.2]{./img/seq1450x1000.png}}
\caption{Последовательная реализация 1450x1000}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.2]{./img/omp1450x1000.png}}
\caption{OMP реализация 1450x1000}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.2]{./img/tbb1450x1000.png}}
