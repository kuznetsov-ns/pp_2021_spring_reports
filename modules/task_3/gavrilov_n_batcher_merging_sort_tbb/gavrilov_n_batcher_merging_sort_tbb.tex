...
\bibitem{Unn.ru} Средства разработки параллельных программ для систем с общей памятью. Библиотека Intel Threading Building Blocks [PDF] // URL: \url{http://www.unn.ru/pages/e-library/aids/2007/12.pdf}
\end{thebibliography}
